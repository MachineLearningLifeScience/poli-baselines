...
class Vocabulary(object):
    ...
    def __init__(
        ...
        self._id_to_token = collections.OrderedDict(zip(self._token_ids, self._tokens))
        self._token_to_id = collections.OrderedDict(zip(self._tokens, self._token_ids))
    ...
    def bos(self):
        ...
        return None if self._bos_token is None else self._token_to_id[self._bos_token]
    ...
    def mask(self):
        ...
        return None if self._mask_token is None else self._token_to_id[self._mask_token]

    @property
    def pad(self):
        """Returns the index of the PAD token or None if unspecified."""
        return None if self._pad_token is None else self._token_to_id[self._pad_token]
